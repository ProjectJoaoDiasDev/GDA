...
namespace GDA.Data.Migrations
{
    public partial class Add_Roles : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("insert studentmanager (Id,Email,Name,RegistrationDate) values (1,'joaodiasworking@gmail.com','Aline',now()); ");
            migrationBuilder.Sql("insert AspNetUsers (Id, StudentManagerId ,UserName, NormalizedUserName, Email, NormalizedEmail, EmailConfirmed, PasswordHash, SecurityStamp, ConcurrencyStamp, PhoneNumber, PhoneNumberConfirmed, TwoFactorEnabled, LockoutEnd, LockoutEnabled, AccessFailedCount) VALUES (N'AC227B87-1620-42D9-860C-E9773381B46D', 1, N'Aline', N'Aline', N'joaodiasworking@gmail.com', N'joaodiasworking@gmail.com', 1, N'ANgdvzXOTMMzLiNMfSctV801fzuTXVBlPPPX9VokVB/Ad8OoEk4sSUPkpcA3ROVaDw==', N'GLYT2WREALAQEOIAT7KCELYGFW6HSR2S', N'CDADC14F-F902-4BA7-B4F6-1E07C5055712', NULL, 0, 0, NULL, 0, 0);");
